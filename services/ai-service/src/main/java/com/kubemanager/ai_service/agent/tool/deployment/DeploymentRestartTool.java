...
public class DeploymentRestartTool implements AiTool {

    private static final String TOOL_NAME = "deployment_restart";
    ...
    public ToolDefinition getToolDefinition() {
        ...
        return ToolDefinition.builder()
                .name(TOOL_NAME)
                .description(
                        "Restarts a Kubernetes deployment by triggering a rolling restart " +
                                "of its pods."
                )
                .inputSchema("""
                        {
    ...
    public ToolResponse execute(ToolRequest request) {
        ...
        try {
            ...
            DeploymentServiceApiResponse response =
                    deploymentServiceClient.restartDeployment(
                            clusterId,
                            namespace,
                            deploymentName
                    );
