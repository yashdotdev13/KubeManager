...
public class PodLogsServiceClient {
    ...
    public PodLogsServiceApiResponse getPodLogs(
            UUID clusterId,
            String namespace,
            String podName,
            String container,
                ...
                restClient
                        ...
                        .uri(uriBuilder ->
                                uriBuilder
                                        .path(
                                                clusterServiceUrl
                                                        + "/api/v1/clusters/{clusterId}/pods/{namespace}/{podName}/logs"
                                        )
                                        .queryParamIfPresent(
                                                "container",
                        ...
                        .retrieve()
                        .body(
                                PodLogsServiceApiResponse.class
                        );
